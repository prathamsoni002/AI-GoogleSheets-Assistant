...
#         try:
#             # Extract actual code by removing #CODE marker
#             code_to_run = code_string.lstrip("#CODE").strip()

#             print("🛠️ Executing AI-generated code:\n", code_to_run)

#             # Define a context with restricted access for safe code execution
#             exec_context = {
#                 "gs_manager": self.gs_manager,
#                 "__builtins__": {
#                     "print": print,
#                     "range": range,
#                     "len": len,
